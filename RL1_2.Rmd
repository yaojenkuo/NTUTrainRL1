...
avgAgeByGender <- ddply(strawHatPirate7, c("gender"), function(df)round(mean(df$age),2))#寫法1
...
經常處理資料的資料分析人員常常面臨資料集轉置(transpose)的問題，reshape2套件透過melt函數與dcast函數能夠幫助我們處理轉置問題，這樣子說明也許很抽象，讓我們來看一個實際的例子。
