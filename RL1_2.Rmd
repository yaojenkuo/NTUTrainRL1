...
avgBountyByGender <- ddply(strawHatPirate, c("gender"), function(df)round(mean(df$bounty, na.rm=T),2))#寫法1
avgAgeByGender <- ddply(strawHatPirate, c("gender"), summarise, avgAge=round(mean(age),2))#寫法2
```
